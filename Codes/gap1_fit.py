...
N,A,dev_A,gap,dev_gap,chi = np.loadtxt(directory+'output/green2_fit_T40.txt', unpack=True, skiprows=1)
...
plt.ylabel(r'$E1-E0 [\hbar\omega]$')
plt.xlabel(r'$\eta^2$')
plt.grid(color = 'gray')
plt.errorbar(eta2,gap,yerr=dev_gap,fmt='.', color='royalblue')
plt.plot(eta2,LinearFit(eta2,*popt), color='plum')
